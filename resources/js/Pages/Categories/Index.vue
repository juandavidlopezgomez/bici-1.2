...
<template>
  <AuthenticatedLayout>
    <template #header>Gestión de Categorías</template>
            ...
            <div class="mt-3 text-center sm:mt-5">
              ...
              <div class="mt-2">
                <p class="text-sm text-gray-500">
                  ¿Estás seguro de que deseas eliminar la categoría <span class="font-semibold">{{ categoryToDelete?.name }}</span>? Esta acción no se puede deshacer.
                </p>
              </div>
            </div>
          </div>
